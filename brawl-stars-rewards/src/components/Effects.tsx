...
export const Sparkle: React.FC<{ style?: React.CSSProperties }> = ({ style }) => {
  return (
    <div className="sparkle absolute pointer-events-none flex items-center justify-center" style={style}>
      <Star className="h-4 w-4 text-yellow-300 fill-yellow-300 drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
      <div className="absolute inset-0 bg-white blur-[2px] rounded-full opacity-40 scale-50" />
    </div>
  );
};
